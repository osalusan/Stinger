...
MeshFiled::MeshFiled()
{
	...
	TextureManager::ReservTexture(m_Texture, L"asset\\texture\\rocky_terrain_02_diff_2k.png");
	TextureManager::ReservTexture(m_Normal, L"asset\\texture\\rocky_terrain_02_nor_gl_512.png");
