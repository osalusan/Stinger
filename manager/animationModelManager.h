...
class AnimationModelManager final
{
private:
	static std::unordered_map<ANIMETION_MODEL, AnimationModelRenderer*> m_LoadModelPool;
...
public:
	...
	static AnimationModelRenderer* GetAnimationModel(const ANIMETION_MODEL& model);
};