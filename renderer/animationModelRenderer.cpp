...
void AnimationModelRenderer::CreateBone(aiNode* node)
{
	BONE bone;
...
void AnimationModelRenderer::Update(const char* AnimationName1, int Frame1)
{
...
void AnimationModelRenderer::Load(const char* FileName)
{
