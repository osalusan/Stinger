...
// プレイヤーの情報
constexpr XMFLOAT3 DEFAULT_SCALE_PLAYER = { 0.048f,0.048f,0.048f };
constexpr XMFLOAT3 DEFAULT_SCALE_SWORD = { DEFAULT_SCALE_PLAYER.x * 55.5f ,DEFAULT_SCALE_PLAYER.y * 55.5f ,DEFAULT_SCALE_PLAYER.z * 55.5f };
constexpr XMFLOAT3 DEFAULT_SCALE_SHILED = { DEFAULT_SCALE_PLAYER.x * 42.0f ,DEFAULT_SCALE_PLAYER.y * 42.0f ,DEFAULT_SCALE_PLAYER.z * 42.0f };
